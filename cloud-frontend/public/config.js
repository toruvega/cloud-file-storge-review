window.APP_CONFIG = {
    ...
    baseUrl: "http://localhost:8080", // - если локально
    // baseUrl: "http://194.87.146.11:8080", // - для сервера
    ...
    * */
    ...
    functions: {
        ...
        mapObjectToFrontFormat: (obj) => {
            ...
            return {
                lastModified: null,
                name: isFolder ? obj.name + "/" : obj.name, // добавляем / в конце имени папки
                size: obj.size,
                path: isFolder ? obj.path + obj.name + "/" : obj.path + obj.name, // и в конце пути
                folder: isFolder
            }
        },
